...
//! Luego de haber prácticado básicamente la asincronia:

//* Vamos a utilizar el sitio JSON PLACEHOLDER API que tiene el fin de proporsionar datos en forma de objetos javascript (JSON) que contienen usuarios, información sobre estos, etc, que llamaremos con una metodo get para poder obtener sus propiedades y luego con estas propiedades crearemos nuestra función que cree los usuarios.
